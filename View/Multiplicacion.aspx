<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/Multiplicacion.aspx.cs" Inherits="View_Multiplicacion" %>
...
<body>
    <form id="form1" runat="server">
	    ...
	    <article class="contenido-principal">
		  <h1 class="animated wobble">MULTIPLICACIÓN</h1>
		    <img src="../imagenes/Calculadora4.jpg" alt="logo" style="height: 356px; width: 24%;"/>
            <p class="animated slideInUp">Escribe los numeros que deseas multiplicar</p>
            <br />
    </form>
    <form  method="GET" oninput="resultado.value=parseInt(num1.value)*parseInt(num2.value)">
                <input type="number" id="num1" class="input"/> x <input type="number" id="num2" class="input"/> =
