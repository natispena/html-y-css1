<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/Division.aspx.cs" Inherits="View_Division" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="../App_Themes/Tema1/style5.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        #num2 {
            height: 21px;
            width: 37px;
...
<body>
    <form id="form1" runat="server">
	    ...
	    <article class="contenido-principal">
		  <h1 class="animated wobble">DIVISIÓN</h1>
		    <img src="../imagenes/Calculadora5.jpg" alt="logo" style="height: 356px; width: 24%;"/>
            <p class="animated slideInUp">Escribe los numeros que deseas dividir</p>
            <br />
    </form>
