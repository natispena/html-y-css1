<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/Resta.aspx.cs" Inherits="View_Resta" %>
...
<body>
    <form id="form1" runat="server">
	    ...
	    <article class="contenido-principal">
		  <h1 class="animated wobble">RESTA</h1>
		    <img src="../imagenes/Calculadora3.jpg" alt="logo" style="height: 356px; width: 24%;"/>
            <p class="animated slideInUp">Escribe los numeros que deseas restar</p>
            <br />
    </form>
